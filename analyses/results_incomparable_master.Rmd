...
This data is up to date up until **`r max(incomparable_master_wide$date)`** and updates automagically via a `@daily` cronjob. All the data and all the plots are refreshed then.  
